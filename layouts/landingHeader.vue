      ...
      <div class="mt-15">
        <v-row>
          <v-col cols="12" xl="5" class="mx-auto">
            <h1 class="white--text text-center display-2 font-weight-regular mb-4">Znalazłeś ogłoszenie sprzedazy samochodu który chcesz kupić?</h1>
            <h4 class="text-h6 white--text text-center font-weight-light mb-5">Sprawdź co wie o nim nasza społeczność!</h4>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" md="12" lg="7" class="mx-auto mb-15">
            <div class="form-location d-flex white rounded flex-wrap">
              <input class="white flex-1 ps-5" type="text" placeholder="Podaj numer VIN lub link do ogłoszenia w Otomoto " />
